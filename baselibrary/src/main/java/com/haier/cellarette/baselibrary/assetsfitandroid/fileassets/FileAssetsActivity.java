...
public class FileAssetsActivity extends AppCompatActivity {
    ...
    public void click_txt(View view) {
        String txt_url = GetAssetsFileMP3TXTJSONAPKUtil.getJson(this, "txt/demo1.txt");
        tv1.setText(txt_url);
    }
    ...
    public void click_fastjson(View view) {
        ...
        try {
            String assets_content = GetAssetsFileMP3TXTJSONAPKUtil.get_assets_content(this,"jsonbean/demobean22.json");
