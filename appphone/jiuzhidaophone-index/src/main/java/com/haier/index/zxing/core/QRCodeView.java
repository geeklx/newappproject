package com.haier.index.zxing.core;
...
//    }
    ...
    public Camera startCameraWine(Context mc) {
        boolean isHava = true;
        if (mCamera != null) {
            isHava = false;
        }
     ...
     * 扫描识酒
     */
    public Camera startSpotWine() {
        startSpotDelayWine(0);
        return mCamera;
    }
     ...
     * @param delay
     */
    public void startSpotDelayWine(int delay) {
//        mSpotAble = true;
//        startCamera();
        // 开始前先移除之前的任务
        removeHand();
...
//                            mDelegate.onScanQRCodeSuccess("未扫描到编码。");
//                            try {
//                                camera.setOneShotPreviewCallback(QRCodeView.this);
//                            } catch (Exception e) {
//                            }
                            removeHand();
                            mHandler.postDelayed(mOneShotPreviewCallbackTask, 3000);
                        }
                    }
                }
            }.perform();
